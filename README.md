...
- [ESP32 Rust toolchain](https://esp-rs.github.io/book/)
  - Recommended version: `1.97.0` (`espup install --toolchain-version 1.97.0.0`)
...
## Build variants
Firmware size (as of commit `24d9c56`):
- Release build: `931,728/4,096,000 bytes, 22.75%`
- Debug build: `1,167,360/4,096,000 bytes, 28.50%`
